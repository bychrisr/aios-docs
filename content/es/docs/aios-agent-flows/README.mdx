...
|---------------|-----------|-----------|
| Agent Reference Guide | docs/agent-reference-guide.md | Referencia rapida |
| Workflows Guide | docs/guides/workflows-guide.md | Guia de workflows |
| AIOS Workflows | docs/aios-workflows/ | Detalle de workflows |
| Architecture | docs/architecture/ | Arquitectura tecnica |
