...
**Documentacion:** ADE-EPIC1-HANDOFF.md
...
**Documentacion:** ADE-EPIC2-HANDOFF.md
...
**Documentacion:** ADE-EPIC3-HANDOFF.md
...
**Documentacion:** ADE-EPIC4-HANDOFF.md
...
**Documentacion:** ADE-EPIC5-HANDOFF.md
...
**Documentacion:** ADE-EPIC6-HANDOFF.md
...
**Documentacion:** ADE-EPIC7-HANDOFF.md
...
- ADE Architect Handoff - Overview general
- ADE Agent Changes - Alteraciones en todos los agentes con matriz de capabilities
- Epic 1 - Worktree Manager
- Epic 2 - Migration V2→V3
- Epic 3 - Spec Pipeline
- Epic 4 - Execution Engine
