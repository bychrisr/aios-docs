...
Consulta CONTRIBUTING.md para guías detalladas.
...
Consulta docs/Squads.md para detalles sobre cómo crear tu propio Squad.
...
Seguimos el Contributor Covenant. Por favor léelo y respétalo.
...
3. Lee nuestro Proceso de Solicitud de Características para guías detalladas

## Hoja de Ruta del Proyecto

¿Quieres saber hacia dónde se dirige AIOS? Consulta nuestra hoja de ruta pública:

- ROADMAP.md - Visión de alto nivel y características planificadas
...
2. **Proponiendo** nuevas características a través del proceso RFC
...
2. **Proceso RFC** - Para características significativas, escribe un RFC usando nuestra plantilla
...
Consulta Proceso de Solicitud de Características para detalles completos.
