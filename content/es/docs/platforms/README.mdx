...
| :-------: | ------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
|  ⭐⭐⭐   | **Claude Code**    | EN \| PT \| [ES](./claude-code.md)          | CLI oficial de Anthropic - **Recomendado**  |
|  ⭐⭐⭐   | **Cursor**         | EN \| PT \| [ES](./cursor.md)                         | Editor de código AI-first con Composer      |
|    ⭐     | **GitHub Copilot** | EN \| PT \| [ES](./github-copilot.md) | Programador par IA de GitHub                |
|   ⭐⭐    | **AntiGravity**    | EN \| PT \| [ES](./antigravity.md)          | Plataforma de desarrollo agéntico de Google |
|    ⭐     | **Gemini CLI**     | EN \| PT \| [ES](./gemini-cli.md)             | Asistente CLI de Google AI                  |
