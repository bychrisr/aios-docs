...
flowchart TD
    ...
    Q1 -->|Sí| CC["Claude Code ⭐ / Mejor integración AIOX"]
...
graph TD
    subgraph "AIOX Core"
        Agents["Definiciones de Agentes / .aiox-core/development/agents"]
        Templates["Templates de IDE / .aiox-core/product/templates"]
