...
flowchart TB
    subgraph CLAUDE_NATIVE["Camada 1: Claude Code Nativo"]
        ...
        CLAUDE_MD_P["CLAUDE.md Projeto / aiox-core/.claude/CLAUDE.md"]
    ...
    subgraph AIOX_FRAMEWORK["Camada 2: AIOX Framework"]
        direction TB
        GOTCHAS["Gotchas Memory / .aiox-core/core/memory/gotchas-memory.js"]
        CTX_SNAP["Context Snapshot / .aiox-core/core/memory/context-snapshot.js"]
        FILE_EVO["File Evolution Tracker / .aiox-core/core/memory/file-evolution-tracker.js"]
        TIMELINE["Timeline Manager / .aiox-core/core/memory/timeline-manager.js"]
        CTX_LOADER["Session Context Loader / .aiox-core/core/session/context-loader.js"]
        CTX_DETECT["Context Detector / .aiox-core/core/session/context-detector.js"]
        SESS_STATE["Session State / .aiox-core/core/orchestration/session-state.js"]
        HOOKS_GEM["Gemini Hooks / .aiox-core/hooks/gemini/"]
        HOOKS_UNI["Unified Hooks / .aiox-core/hooks/unified/"]
    end
...
flowchart TD
    ...
    subgraph LOAD["Carregamento Automatico — Ordem Fixa"]
        ...
        LOAD_PROJECT["3. aiox-core/.claude/CLAUDE.md / Instrucoes nivel projeto"]
        LOAD_RULES["4. aiox-core/.claude/rules/*.md / 5 arquivos de regras detalhadas"]
...
flowchart LR
    ...
    NOTE["NOTA: Apenas agentes / definidos em .claude/agents/ / usam esta memoria. / Agentes AIOX (.aiox-core/ / development/agents/) / NAO usam."]
...
flowchart TD
    subgraph GOTCHAS["gotchas-memory.js — Epic 9, Story 9.4"]
        ...
        G5[("Persiste em: / .aiox/gotchas.json / .aiox/gotchas.md / .aiox/error-tracking.json")]
    end
    ...
    subgraph SNAPSHOTS["context-snapshot.js — Story 12.6"]
        ...
        S5[("Persiste em: / .aiox/snapshots/[id].json")]
    end
    ...
    subgraph FILE_EVO["file-evolution-tracker.js"]
        ...
        F4[("Persiste em: / .aiox/file-evolution/ / evolution-index.json")]
    end
    ...
    subgraph TIMELINE_MGR["timeline-manager.js — Facade Unificada"]
        ...
        T4[("Persiste em: / .aiox/timeline/ / unified-timeline.json")]
    end
...
flowchart TD
    ...
    subgraph CTX_LOADER["context-loader.js"]
        ...
        CL8["onTaskComplete()"]
        CL9[("Persiste em: / .aiox/session-state.json / TTL: 1 hora")]
...
sequenceDiagram
    ...
    Note over CC: NENHUMA memoria AIOX / e carregada automaticamente / no system prompt. / Apenas contexto de sessao / aparece no greeting.
```
...
flowchart TD
    ...
    subgraph SAVES["O Que e Salvo"]
        S1[".aiox/session-state.json / Agente atual, comandos, workflow"]
        S2[".aiox/error-tracking.json / Ocorrencia do erro"]
        S3[".aiox/gotchas.json / Nova gotcha auto-capturada"]
        S4[".aiox/gotchas.json / Gotcha manual adicionada"]
        S5["docs/stories/.session-state.yaml / Phase atualizada"]
        S6["docs/stories/.session-state.yaml / Story marcada done"]
        S7[".aiox/snapshots/[id].json / Contexto capturado"]
        S8[".aiox/file-evolution/ / Evolucao registrada"]
    end
...
flowchart TD
    subgraph SOURCES["Fontes de Dados"]
        SRC1["FileEvolutionTracker / .aiox/file-evolution/"]
        SRC2["ContextSnapshot / .aiox/snapshots/"]
    ...
    subgraph STORAGE["Storage"]
        ST1[(".aiox/timeline/ / unified-timeline.json")]
    end
