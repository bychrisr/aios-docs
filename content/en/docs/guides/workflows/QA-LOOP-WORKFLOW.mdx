...
flowchart TD
    ...
    V -->|"APPROVE"| A["Action: COMPLETE / Story aprovada apos N iteracoes"]
    V -->|"BLOCKED"| B["Action: ESCALATE / Requer intervencao humana"]
    V -->|"REJECT"| C["Action: CONTINUE / Prosseguir para criar fix request"]
...
flowchart TD
    ...
    I -->|"Sim"| E["ESCALATE / Max iterations reached without APPROVE"]
    I -->|"Nao"| C["CONTINUE / Voltar para Step 1 (review) / iteration++"]
