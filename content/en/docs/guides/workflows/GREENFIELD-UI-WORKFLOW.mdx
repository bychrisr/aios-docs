...
graph LR
    subgraph "Planejamento"
        AN[Atlas / @analyst] --> PM[Morgan / @pm]
        PM --> UX[Uma / @ux-expert]
        UX --> AR[Aria / @architect]
    end
...
- AIOS Knowledge Base - Base de conhecimento central
- Brownfield Workflow - Workflow para projetos existentes (se disponivel)
