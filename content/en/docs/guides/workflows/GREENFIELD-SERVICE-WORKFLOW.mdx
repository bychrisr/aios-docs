---
title: "Greenfield Service Workflow"
---
...
```mermaid
flowchart TD
    D1{Arquitetura sugere / mudancas no PRD?}
    D2{PO encontrou / problemas?}
    D3{Revisar story / draft?}
    D4{Revisao QA?}
    D5{QA encontrou / problemas?}
    D6{Mais stories?}
    D7{Retrospectiva / do epic?}
