...
flowchart TD
    ...
    subgraph PHASE1["📦 FASE 1: Build &amp; Compile"]
        B[ux-design-expert: / Build componentes atomicos]
    ...
    subgraph PHASE2["📚 FASE 2: Documentation"]
        D[ux-design-expert: / Gerar documentacao Pattern Library]
    ...
    subgraph PHASE3["♿ FASE 3: Quality Assurance"]
        G[ux-design-expert: / Auditoria a11y WCAG AA]
    ...
    subgraph PHASE4["💰 FASE 4: ROI Analysis"]
        J[ux-design-expert: / Calcular ROI e savings]
