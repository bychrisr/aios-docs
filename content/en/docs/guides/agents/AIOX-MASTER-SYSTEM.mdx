...
flowchart TB
    subgraph ACTIVATION["🚀 ATIVACAO"]
        ...
        GREETING["greeting-builder.js / Saudacao Inteligente"]
    end
    ...
    subgraph DELEGATION["🤝 DELEGACAO"]
        PM["@pm / Epics/Stories"]
        ANALYST["@analyst / Brainstorming"]
        ARCHITECT["@architect / AI Prompts"]
        QA["@qa / Test Suites"]
    end
...
flowchart LR
    subgraph MASTER["👑 @aiox-master (Orion)"]
        MASTER_DESC["Orquestra todos os agentes / Cria/modifica componentes / Executa qualquer task"]
    end
    ...
    subgraph DELEGATED["🔀 RESPONSABILIDADES DELEGADAS"]
        ...
        subgraph PM_BOX["📋 @pm"]
            PM_DESC["*create-epic / *create-story"]
        end
