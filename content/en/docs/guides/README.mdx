...
| **MCP API Keys Management** | Secure credential handling      | 10 min | DevOps    |
...
| Guide                                                              | Purpose                               | Time   | Audience               |
| ------------------------------------------------------------------ | ------------------------------------- | ------ | ---------------------- |
| **Module System Architecture** | v4.2 modular architecture (4 modules) | 15 min | Architects, Developers |
| **[Service Discovery Guide](./service-discovery.md)**              | Worker discovery and registry API     | 10 min | Developers             |
| **Migration Guide v2.0→v4.2**      | Step-by-step migration instructions   | 20 min | All users upgrading    |
