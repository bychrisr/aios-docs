...
flowchart TB
    ...
    subgraph ANALYST["@analyst (Atlas) - 业务分析师"]
        BRAINSTORM["*brainstorm [topic] / 结构化会话"]
        RESEARCH["*research-prompt [topic] / 研究提示"]
        MARKET_RES["*perform-market-research / 市场研究"]
        COMPETITOR["*create-competitor-analysis / 竞争分析"]
        BRIEF["*create-project-brief / 项目简介"]
        ELICIT["*elicit / 高级获取"]
    end
...
```mermaid
flowchart TD
    START["开始：*brainstorm [topic]"] --> SETUP["阶段 1：设置 / 4 个背景问题"]
...
stateDiagram-v2
    ...
    note right of DIVERGENT_THINKING: 热身：5-10 分钟 / 生成：20-30 分钟
