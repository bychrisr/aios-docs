...
- 查找标记为 [`good-first-issue`](https://github.com/SynkraAI/aios-core/labels/good-first-issue) 的 issue
- 检查 [`help-wanted`](https://github.com/SynkraAI/aios-core/labels/help-wanted) 以获得更复杂的任务
- 浏览 [开放讨论](https://github.com/SynkraAI/aios-core/discussions) 以帮助他人
...
- **想法** - 提议新功能和改进
- **问答** - 获得技术问题的帮助
- **展示和讲述** - 分享您使用 AIOS 创建的项目
- **故障排除** - 获得解决问题的帮助
- **小队** - 关于 AIOS Squads（模块化代理团队）的讨论
- **MCP 生态系统** - 关于 MCP 工具和集成的讨论

[加入讨论](https://github.com/SynkraAI/aios-core/discussions)

### Issue 跟踪器

用于错误报告和功能请求：

- [aios-core Issues](https://github.com/SynkraAI/aios-core/issues) - 核心框架
...
任何以任何方式对 AIOS 做出贡献的人。
- 在我们的 [贡献者页面](https://github.com/SynkraAI/aios-core/graphs/contributors) 上列出
- 在发布说明中提及重大贡献
...
所有贡献者都在我们的 [贡献者页面](https://github.com/SynkraAI/aios-core/graphs/contributors) 上被认可。
...
1. 查看 [文档](../)
2. 搜索 [现有讨论](https://github.com/SynkraAI/aios-core/discussions)
3. 在问答讨论中提问
4. 打开故障排除讨论

### 发现了一个 bug？

1. 搜索 [现有 issue](https://github.com/SynkraAI/aios-core/issues)
2. 如果是新的，[打开错误报告](https://github.com/SynkraAI/aios-core/issues/new?template=bug_report.md)
...
- [AIOS GitHub 组织](https://github.com/SynkraAI)
- [变更日志](../CHANGELOG.md)
...
- 当前版本：见 [发布](https://github.com/SynkraAI/aios-core/releases)
