...
See docs/Squads.md for details on creating your own Squad.
...
We follow the Contributor Covenant. Please read and respect it.
...
3. Read our Feature Request Process for detailed guidelines

## Project Roadmap

Want to know where AIOS is headed? Check out our public roadmap:

- ROADMAP.md - High-level vision and planned features
...
2. **Proposing** new features via the RFC process
...
2. **RFC Process** - For significant features, write an RFC using our template
3. **Community Voting** - Use :+1: reactions to show support
4. **Implementation** - Approved ideas move to our backlog

See Feature Request Process for complete details.
