...
Para features significativas que precisam de design detalhado, submeta um RFC seguindo nosso processo estruturado.

### 4. Contribua Diretamente

Encontrou algo que quer implementar? Veja nosso Guia de Contribuição e Processo de Features.
