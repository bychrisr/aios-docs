---
title: "Aios Livro De Ouro V2.1 Summary"
---
...
2. **Discovery CLI**
   ...
   aios workers search           # Semantic search
   aios workers info         # Details
   aios workers find-for-task     # Find suitable Worker
   aios workers validate     # Check compliance
   ```
...
4. **Contribution System**
   ...
   aios workers test         # Run validation
   aios workers submit       # Submit to registry
   ```
