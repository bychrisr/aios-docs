...
You don't redesign a button every time you need one. You use the `` component.
Similarly, you don't redesign a "Quality Assurance Persona" every time. You use the `` component.
...
5. Test with `aios agent validate `
```
