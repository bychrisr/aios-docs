...
sequenceDiagram
    ...
    participant CLI as CLI / (mcp setup)
    participant Mgr as Gerenciador / de Config
    participant FS as Sistema de / Arquivos
    participant Detector as Detector / de SO
...
sequenceDiagram
    actor User as Usuário
    participant CLI as CLI / (mcp link)
    participant Symlink as Gerenciador / de Symlink
    participant Migrator as Migrador / de Config
    participant Mgr as Gerenciador / de Config
    participant FS as Sistema de / Arquivos
