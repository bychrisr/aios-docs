...
Veja CONTRIBUTING-PT.md para diretrizes detalhadas.
...
Veja docs/Squads.md para detalhes sobre como criar seu próprio Squad.
...
3. Leia nosso Processo de Solicitação de Features para diretrizes detalhadas

## Roadmap do Projeto

Quer saber para onde o AIOS está indo? Confira nosso roadmap público:

- ROADMAP-PT.md - Visão de alto nível e funcionalidades planejadas
...
2. **Propondo** novas features via o processo de RFC
...
2. **Processo RFC** - Para features significativas, escreva um RFC usando nosso template
3. **Votação da Comunidade** - Use reações :+1: para mostrar apoio
4. **Implementação** - Ideias aprovadas vão para nosso backlog

Veja Processo de Solicitação de Features para detalhes completos.
