---
title: "Story Syn 10 Memory Bridge"
---
...
- **Engine Integration**
  ...
  - Include memory section in `` XML output via formatter
...
6. **Engine Integration**
   ...
   - Formatter includes `[MEMORY HINTS]` section in `` XML when hints present
...
- [x] **Task 5: Formatter Update** [AC: 6]
  - [x] Add `[MEMORY HINTS]` section to `` XML
